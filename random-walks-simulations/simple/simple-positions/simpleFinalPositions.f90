include 'simplePositionsModule.f90'
program simpleFinalPositions
   !!  ---------------------------------------------------------------------
   !!  |  SIMULATION PROGRAM FOR THE SIMPLE RANDOM WALKER FINAL POSITIONS  |
   !!  ---------------------------------------------------------------------
   !!
   use omp_lib
   use simplePositionsModule
   implicit none
   ...
   !! DISTRIBUTION
   open(1, file='../../../data/position-distribution/distributions/simple_distribution_pos.txt', status='replace')
      do i=1,2*maxDistance+1
   ...
   !! STEPS
   open(1, file='../../../data/position-distribution/information/simple_cases_pos.txt', status='replace')
      do i=1,cases
         write(1,*) steps(i)
      end do
   close(1)
   ...
   !! VARIANCE
   open(1, file='../../../data/position-distribution/statistics/simple_variance_pos.txt', status='replace')
      do i=1,momentsTime
   ...
   !! SKEWNESS
   open(1, file='../../../data/position-distribution/statistics/simple_skewness_pos.txt', status='replace')
      do i=1,momentsTime
   ...
   !! KURTOSIS
   open(1, file='../../../data/position-distribution/statistics/simple_kurtosis_pos.txt', status='replace')
      do i=1,momentsTime
   ...
   !! SIMULATION INFO
   open(1, file='../../../data/position-distribution/information/simple_info_pos.txt', status='replace')
      do i=1,4
   ...
   !! RAW MOMENTS
   open(1, file='../../../data/position-distribution/statistical-moments/simple_m1_pos.txt', status='replace')
      do i=1,momentsTime
         write(1,*) s1(1,i), s1(2,i), s1(3,i);
      end do
   close(1)
   open(1, file='../../../data/position-distribution/statistical-moments/simple_m2_pos.txt', status='replace')
      do i=1,momentsTime
         write(1,*) s2(1,i), s2(2,i), s2(3,i);
      end do
   close(1)
   open(1, file='../../../data/position-distribution/statistical-moments/simple_m3_pos.txt', status='replace')
      do i=1,momentsTime
         write(1,*) s3(1,i), s3(2,i), s3(3,i);
      end do
   close(1)
   open(1, file='../../../data/position-distribution/statistical-moments/simple_m4_pos.txt', status='replace')
      do i=1,momentsTime
